...
int perturb_sources(
  ...
  sprintf(file, "output/delta.dat");
  FILE *fout;
  fout = fopen(file, "a");
  fprintf(fout,"%e %e %e %e %e %e\n",z,k,y[ppw->pv->index_pt_delta_b],-dy[ppw->pv->index_pt_delta_b]/ppw->pvecback[pba->index_bg_H], ppw->pvecback[pba->index_bg_H],0);
 /*
 
 fprintf(fout,"%e %e %e %e %e %e\n",z,k,y[ppw->pv->index_pt_delta_b],-dy[ppw->pv->index_pt_delta_b]/ppw->pvecback[pba->index_bg_H], ppw->pvecback[pba->index_bg_H], -dy[ppw->pv->index_pt_phi]/ppw->pvecback[pba->index_bg_H]);
  */
