...
infile_cmb = "/Users/NanoomLee/Documents/Master@StonyBrook/ISW_21cm_Code/noise_joel/fisher_matrix_logAs_woNeff.txt"
...
infile_cmb = result + "fisher_matrix_BBN_{}_Neff_fsky0.4.txt".format(lmax)
infile_cl21T = result + "fisher_matrix_cl21T_BBN_{}_fsky0.4.txt".format(lmax)
