...
# With Yp, contant noise (1500)
infile_cmb = "/Users/NanoomLee/Documents/Master@StonyBrook/ISW_21cm_Code/New_logAs_NL_Yp_result/fisher_matrix_new_nl_Yp_logAs_1500_wom_nu.txt"
...
# With Yp, noise from joel
infile_cmb = "/Users/NanoomLee/Documents/Master@StonyBrook/ISW_21cm_Code/noise_joel/fisher_matrix_wom_nu.txt"
infile_cl21T = '/Users/NanoomLee/Documents/Master@StonyBrook/ISW_21cm_Code/logAs_Yp_result/fisher_matrix_cl21T_Yp_l3000_fsky0.7.txt'
infile_zm = '/Users/NanoomLee/Documents/Master@StonyBrook/ISW_21cm_Code/logAs_Yp_result/fisher_matrix_cl21T_Yp_{}.txt'.format(z_m)

result = "/Users/NanoomLee/Documents/Master@StonyBrook/ISW_21cm_Code/ISW_21cm/result/"
infile_cmb = result + "fisher_matrix_BBN_3000_mnu_fsky0.4.txt"
infile_cl21T = result + "fisher_matrix_cl21T_BBN_3000_fsky0.4.txt"
infile_cl21T = result + "k1e-1/fisher_matrix_cl21T_BBN_k1e-1.txt"
#infile_cl21T = result + "800Mpc_modified/fisher_matrix_cl21T_BBN_3000_fsky0.4.txt"
infile_zm = result + "k1e-1/fisher_matrix_cl21T_BBN_{}.txt".format(z_m)
#infile_zm = result + "fisher_matrix_cl21T_BBN_{}.txt".format(z_m)
...
fisher2 = []
for i in range(8):
		fisher2.append (prior_planck[i] + prior_cmb[i] + fisher_cl21T[i])
...
for i in range(7):
	...
	if i == 6:
		sigma2.append (np.sqrt(inv_fisher2[i+1,i+1]))
	else:
...
for i in [0,1,5,3,4,6,2,7]:#range(len(inv_fisher1)):
	if i < 4:
		...
		print ('%1.4e %1.4e %1.4e %1.4e %1.4e %1.4e' % (0, np.sqrt(inv_prior_cmb[i-1,i-1]), np.sqrt(inv_fisher_cl21T[i,i]), np.sqrt(inv_fisher1[i-1,i-1]), np.sqrt(inv_fisher2[i,i]),improve[i-1]))
